...
public class MerchantController {
	...
	public ModelAndView addProduct(@PathVariable int merchantId,@ModelAttribute("product") Product product) throws ProductNotFoundException {
	...
	public ModelAndView getRemoveProductPage(@ModelAttribute("product") Product product, @RequestParam("abc")int merchantId) {
	...
	public ModelAndView updateProd(@ModelAttribute("product") Product product,@PathVariable int productId) throws ProductNotFoundException {
